...
global.config = {
    ...
    msg: {
        admin: quote("⛔ Kocak banget member satu ini 😹🫵!"), // Pesan saat perintah hanya untuk admin
        banned: quote("⛔ lu di ban deck 😹!"), // Pesan untuk pengguna yang dibanned
        ...
        owner: quote("⛔ lu siapa mek 😹!"), // Pesan untuk perintah yang hanya owner bisa akses
